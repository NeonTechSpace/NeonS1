...
export interface NativeValidationRequest {
    readonly schema: 'neons1-native-recipe-validation-request-1';
...
export interface NativeValidationResponse {
    readonly schema: 'neons1-native-recipe-validation-response-1';
...
export interface NativeValidationReport {
    readonly schema: 'neons1-native-recipe-validation-report-1';
...
export function createNativeValidationRequest(
    ...
    return {
        schema: 'neons1-native-recipe-validation-request-1',
...
export function parseNativeValidationRequest(value: unknown): NativeValidationRequest {
    ...
    if (record.schema !== 'neons1-native-recipe-validation-request-1') {
...
export function parseNativeValidationResponse(value: unknown): NativeValidationResponse {
    ...
    if (record.schema !== 'neons1-native-recipe-validation-response-1') {
...
export function compareNativeValidation(
    ...
    return {
        schema: 'neons1-native-recipe-validation-report-1',
