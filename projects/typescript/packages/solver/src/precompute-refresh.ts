...
export interface RecipeCorpusProductionSelection {
    readonly schema: 'neons1-recipe-corpus-production-selection-1';
...
interface RefreshLock {
    readonly schema: 'neons1-recipe-corpus-refresh-lock-1';
...
function buildSelection(
    ...
    return {
        schema: 'neons1-recipe-corpus-production-selection-1',
...
async function acquireLock(lockPath: string): Promise<() => Promise<void>> {
    const lock: RefreshLock = {
        schema: 'neons1-recipe-corpus-refresh-lock-1',
        token: randomUUID(),
        pid: process.pid,
...
async function readLock(lockPath: string): Promise<RefreshLock | null> {
    try {
        ...
        return value.schema === 'neons1-recipe-corpus-refresh-lock-1' &&
...
function parseSelection(value: unknown): RecipeCorpusProductionSelection {
    ...
    if (record.schema !== 'neons1-recipe-corpus-production-selection-1') {
