...
[assembly: MelonInfo(
    typeof(NeonS1.GameDataExporter.ExporterMod),
    "NeonS1 Game Data Exporter",
    NeonS1.GameDataExporter.ExporterMod.ExporterVersion,
    "NeonTechSpace")]
...
public sealed class ExporterMod : MelonMod
{
    ...
    private const string OutputEnvironmentVariable = "NEONS1_EXPORT_OUTPUT";
    ...
    private void RunAfterLoad()
    {
        try
        {
            ...
            var assetDirectoryName = $"neons1-assets-{runId}";
