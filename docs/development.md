...
| Production and inventory | Partial | Growing, packaging, additives, brick pressing, equipment needs, production time and cost, finished-recipe planning, inventory shortages, purchases, property transfers, capacity-limited transfer arrival timing, selected shopping attribution by property, one-property input readiness, and elapsed lifecycle composition through a completed sale | Transfer timing and property-specific shopping readiness require caller-supplied movement evidence. Exact lifecycle timing also requires exclusive sequential execution evidence and an explicit direct or delivered sale, while persistent inventory and live execution remain unavailable |
