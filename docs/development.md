...
| Production and inventory | Partial | Growing, packaging, additives, brick pressing, equipment needs, production time and cost, finished-recipe planning, inventory shortages, purchases, property transfers, and one-property input readiness after shopping | Readiness requires matching dataset identity, exact selected quantities, and an explicit production-property arrival destination, while transfer arrival timing and multi-property purchase attribution remain unavailable |
